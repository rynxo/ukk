...
$query = $con->query("SELECT * FROM masakan WHERE type != 'minuman'");
?>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <ul class="nav justify-content-between">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="menum.php">Halaman Minuman</a>
                    </li>
                </ul>
            </div>
                        ...
                        while ($row = $query->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= BASE; ?>delete/delete.menu.php?id=<?= $row['id_masakan']; ?>" onclick="return confirm('apakah anda yakin?')" class="btn btn-dark btn-sm"><i class="fas fa-trash"></i> HAPUS</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
